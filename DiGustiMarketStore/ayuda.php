...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			//--------------------------------------SECCION EXCLUSIVA DEL CONTENIDO DE AYUDA-----------------------------------------------//
...
?>
	...
	<!-- ///////////////////////////////////////////////// CONTENIDO ///////////////////////////////////////////////////////////// -->
	<div id="contenido">
		<h1 style="font-family: courgette; font-size: 3em; margin-top: 80px; margin-bottom: 20px;">Manual de Usuario</h1>
		<div class="manual" style="text-align: center; width: 60%; margin:0 auto; font-size: 1.5em; font-family: lobster; float: none;">
			Dale click al link en Rojo para abrir en una página aparte el 
			<label id="manual1" style="text-decoration: underline; color: red; cursor: pointer;">Manual de Usuario</label>
		</div>
		<iframe src="Guia.pdf" style="width: 80%; height: 500px; margin-bottom: 30px; margin-top: 30px"></iframe>
	</div>
		...
		<div class="juramental">	<!-- 3 BLOQUES DE INFORMACION -->
			...
			<section class="bloque">
				<div class="jur">
					...
					<img src="Alimentos/logo2.png" width="250" height="100"> <br>
